...
makeAnimatedLuaSprite('rain', 'rain', 0, -210);
scaleObject('rain', 1, 1);
addAnimationByPrefix('rain', 'loop', 'rain loop', 17, true);
objectPlayAnimation('rain', 'loop');
addLuaSprite('rain', false);
setObjectCamera('rain', 'hud');

makeAnimatedLuaSprite('splash', 'splash', -400, -340);
scaleObject('splash', 1.8, 1.8);
addAnimationByPrefix('splash', 'loop', 'splash loop', 17, true);
objectPlayAnimation('splash', 'loop');
addLuaSprite('splash', false);
setObjectCamera('splash', 'game');

makeAnimatedLuaSprite('niebla 1', 'niebla', 1460, 120);
scaleObject('niebla 1', 1.8, 1.8);
addAnimationByPrefix('niebla 1', 'loop', 'niebla loop', 17, true);
...
addAnimationByPrefix('niebla 2', 'loop', 'niebla loop', 16, true);
...
addAnimationByPrefix('niebla 3', 'loop', 'niebla loop', 15, true);
...
addAnimationByPrefix('niebla 4', 'loop', 'niebla loop', 14, true);
...
addAnimationByPrefix('niebla 5', 'loop', 'niebla loop', 13, true);
