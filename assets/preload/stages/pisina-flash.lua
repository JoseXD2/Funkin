...
addAnimationByPrefix('zombie 2', 'idle', 'buckethead idle', 12, true);
...
addAnimationByPrefix('zombie 3', 'idle', 'conehead idle', 12, true);
...
addAnimationByPrefix('zampalga xd','idle','tanglekelp idle', 44, true)
