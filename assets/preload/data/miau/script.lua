...
Artists = 'Diego-Renatox,XEnderxp,marko,gargan' --(Artist(s) Name(s))
Musicians = 'MrThiaG014' --(Musician(s) Name(s))
Charters = 'MrThiaG014' --(Charter(s) Name(s))
...
ArtistBarLength  = 1100 --(Changes the length of the bar the artist name(s) rest on)
...
MusicianBackgroundBarColor = 'fafc10'
CharterBackgroundBarColor = 'fafc10'
--------------------
...
MusicianNameBorderColor = 'fc6a10'
CharterNameBorderColor = 'fc6a10'
...
MusicianHeaderBorderColor = 'fc6a10'
CharterHeaderBorderColor = 'fc6a10'
