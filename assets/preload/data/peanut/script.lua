...
Artists = 'Diego-Renatox,Arkly,ppcatga' --(Artist(s) Name(s))
Musicians = 'Emi_12' --(Musician(s) Name(s))
Charters = 'Emi_12' --(Charter(s) Name(s))
...
ShowIcons = 'true'	--(Options are 'true' or 'false')
	...
	ChartIcon = 'Emi' --(Charter(s) Icon Name)
	ChartIconOffsetX = 0 --(Postive moves LEFT, Negative moves RIGHT)
	ChartIconOffsetY = -80 --(Postive moves UP, Negative moves DOWN)
...
ArtistBarLength  = 800 --(Changes the length of the bar the artist name(s) rest on)
MusicianBarLength  = 260 --(Changes the length of the bar the musician name(s) rest on)
CharterBarLength  = 260 --(Changes the length of the bar the charter name(s) rest on)

--(Uses Hex Color Codes)
CodingBackgroundBarColor = '0fe718'
ArtistBackgroundBarColor = 'a6e910'
MusicianBackgroundBarColor = 'e6ebe5'
CharterBackgroundBarColor = 'e6ebe5'
--------------------
...
FontSize = 50 --(Changes the size of every letter & the thickness of each bar)
...
MusicianNameBorderColor = 'fcfcfc'
CharterNameBorderColor = 'fcfcfc'
...
CharterHeaderColor = '000000'
--------------------
CoderHeaderBorderColor = '0fe718'
ArtistHeaderBorderColor = 'e9e510'
MusicianHeaderBorderColor = 'e910d3'
CharterHeaderBorderColor = 'e910d3'
