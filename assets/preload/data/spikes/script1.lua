...
ScriptDuration = 2 --(The amount of time the credits are shown on screen in seconds)

Coders = 'Arkly' --(Coder(s) Name(s))
Artists = 'Diego-Renatox,XEnderxp,Lyno,Marko,ppcatga' --(Artist(s) Name(s))
Musicians = 'InotcuaTheNeo' --(Musician(s) Name(s))
