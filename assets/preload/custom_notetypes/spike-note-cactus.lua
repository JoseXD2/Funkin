function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'spike-note-cactus' then --Check if the note on the chart is a Shootems Note
...
function goodNoteHit(id, direction, noteType, isSustainNote)
	if noteType == 'spike-note-cactus' then
